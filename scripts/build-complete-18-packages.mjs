...
const packagesData = [
  ...
  },
  {
    ...
    exclusions: [
      ...
      "Indonesia visa on arrival (USD 35 / AED 130 payable at airport or online)",
    ...
    importantInfo: [
      ...
      { title: "Best Season", body: "April to October brings dry, sunny beach weather across Bali and Nusa Penida." }
    ],
    faqs: [
      ...
      { q: "Is Halal food available in Bali?", a: "Yes, Halal food is widely available across Bali, especially grilled seafood in Jimbaran and international dining." }
    ]
  },
  {
    ...
    exclusions: [
      ...
      "Japan visa embassy processing fees (if applicable)",
      "Lunch and dinner meals not specified",
      "Travel insurance"
    ],
    accommodation: {
    ...
    importantInfo: [
      ...
      { title: "Cherry Blossom Season", body: "Peak Sakura blooming occurs between late March and mid-April across Tokyo, Kyoto, and Osaka." }
    ],
    faqs: [
      ...
      { q: "Is Halal food available in Japan?", a: "Yes, Tokyo, Kyoto, and Osaka have certified Halal ramen shops, Halal Kobe/Wagyu beef restaurants, and vegetarian options." }
    ]
  }
];
...
console.log('Saved all 10 international packages successfully with full detail!');
