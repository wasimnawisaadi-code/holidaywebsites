...
const packagesData = [
  {
    ...
    importantInfo: [
      ...
      { title: "Currency & Payments", body: "Local currency is Azerbaijani Manat (AZN). Credit cards are widely accepted across Baku." },
      { title: "Seasonality & Weather", body: "Spring and Autumn offer pleasant 20°C sightseeing weather. Winter brings snow to Gabala ski resort." }
    ],
    faqs: [
      ...
      { q: "Can we extend the trip to include Sheki or Shahdag?", a: "Yes, we can customize your itinerary to include 2 nights in the Silk Road city of Sheki or Shahdag Mountain Resort." },
      { q: "What is the food like in Azerbaijan?", a: "Azerbaijani cuisine is 100% Halal and world-famous for skewered kebabs, saffron plov, fresh Caspian fish, and warm tandoor flatbreads." }
    ]
  },
  {
    ...
    importantInfo: [
      ...
      { title: "Emirates ID & Passport", body: "Original passport with minimum 6 months validity and Emirates ID required for border crossing." },
    ...
    faqs: [
      ...
      { q: "Is Salalah really green during summer?", a: "Yes! Dhofar catches the Indian Ocean monsoon, creating genuine rainforest conditions with waterfalls while the rest of the GCC is hot." },
      { q: "Is this tour suitable for families with infants?", a: "The flight package is ideal for families with young children, while the bus package is popular with adults, couples, and teenagers." },
      { q: "What should we buy in Salalah?", a: "Salalah is the world capital of royal Hojari Frankincense, natural perfumes, fresh mountain honey, and local Omani Halwa." }
    ]
  },
  {
    ...
    importantInfo: [
      ...
      { title: "Vaccination & Health", body: "Meningitis vaccination and valid health record recommended prior to departure." },
    ...
    faqs: [
      ...
      { q: "How close are the hotels to the Holy Mosques?", a: "3★ hotels are 350-500m away, 4★ hotels are 150-250m, and 5★ hotels are located directly on the Haram courtyard." },
      { q: "Do you assist with Nusuk permits for Rawdah Sharif?", a: "Yes, our operations team guarantees advance scheduling of your official Rawdah Sharif visiting slot on Nusuk." },
      { q: "Can we customize the number of days in Makkah and Madinah?", a: "Yes, we arrange 7-night, 10-night, 14-night, and 21-night packages tailored to your schedule." }
    ]
  },
  {
    ...
    dayBlocks: [
      ...
      { day: 2, morning: "Guided tour of Sarajevo: Latin Bridge (site of 1914 event), Gazi Husrev-beg Mosque, Sahat Kula Clock Tower, and the Tunnel of Hope museum.", afternoon: "Visit Vrelo Bosne, the lush natural springs of the River Bosna, with horse-drawn carriage rides along tree-lined avenues.", evening: "Traditional Bosnian dinner featuring authentic Ćevapi and Burek pastries in the Old Town.", overnight: "Overnight in Sarajevo", meals: "Breakfast included" },
    ...
    importantInfo: [
      ...
      { title: "Currency", body: "Bosnian Convertible Mark (BAM). 1 BAM ≈ 2 AED. Euros are also widely accepted." }
    ],
    faqs: [
      ...
      { q: "What is the weather like in Bosnia?", a: "Summers (June–August) are warm and sunny (25–28°C), perfect for waterfalls, while winters offer snow and skiing on Olympic mountains." }
    ]
  },
  {
    ...
    dayBlocks: [
      ...
      { day: 3, morning: "Ascend Mount Titlis aboard the world's first revolving Rotair cable car through alpine clouds.", afternoon: "Walk across the Titlis Cliff Walk (Europe's highest suspension bridge) and explore the Glacier Ice Cave.", evening: "Return to Lucerne for a relaxed fondue evening.", overnight: "Overnight in Lucerne", meals: "Breakfast included" },
      { day: 4, morning: "Board the GoldenPass panoramic train toward Interlaken between Lakes Thun and Brienz.", afternoon: "Stroll the Höheweg promenade with views of the Jungfrau massif; optional tandem paragliding.", evening: "Traditional Swiss chalet dinner in Interlaken.", overnight: "Overnight in Interlaken", meals: "Breakfast included" },
    ...
    importantInfo: [
      ...
      { title: "Best Time to Travel", body: "May to September for green alpine meadows and lakes; December to March for winter snow wonderland and skiing." }
    ],
    faqs: [
      ...
      { q: "Is Switzerland suitable for children?", a: "Children under 16 travel 100% free on all Swiss trains with the complimentary Swiss Family Card." }
    ]
  },
  {
    ...
    faqs: [
      ...
      { q: "Is the food Halal in Maldives?", a: "All meat served across luxury resorts in the Maldives is 100% Halal certified." }
    ]
  },
  {
    ...
    faqs: [
      ...
      { q: "Can we do paragliding in Gudauri?", a: "Yes, tandem paragliding over the Caucasus valley can be added during the Gudauri stop on Day 3." },
      { q: "Is Halal food available in Georgia?", a: "Yes, Tbilisi has numerous Halal-certified restaurants and vegetarian Georgian dishes like Lobio and Ajapsandali." }
    ]
  },
  {
    ...
    faqs: [
      ...
      { q: "Are cave hotel rooms comfortable and warm?", a: "Yes, our luxury cave hotels have heated floors, luxury en-suite marble bathrooms, and jacuzzi tubs." },
      { q: "Is the food Halal in Turkey?", a: "Yes, 100% of all food and dining options across Turkey are Halal." }
    ]
  }
];

const packagesFormatted = packagesData.map(p => ({
  slug: p.slug,
  title: p.title,
...
const half = Math.ceil(packagesData.length / 2);
const detailsA = {};
const detailsB = {};

packagesData.forEach((p, idx) => {
  if (idx < half) {
...
console.log('Saved all flawless packages successfully!');
