...
export const packageDetailsA: Record<string, PackageDetail> = {
  "baku-wonders": {
    ...
    "dayBlocks": [
      {
        "day": 1,
        "morning": "Direct 3-hour flight from Dubai DXB to Heydar Aliyev International Airport in Baku. VIP meet-and-greet at arrivals and private transfer to your central 4-star hotel.",
        "afternoon": "Check into your hotel, freshen up, and take a leisurely orientation walk along Nizami Street (Torgovaya), Baku's bustling pedestrian shopping boulevard.",
        "evening": "Head to Highland Park (Dagustu Park) for panoramic sunset views over Baku Bay and the illuminated Flame Towers LED light show.",
        "overnight": "Overnight at 4★ Central Hotel, Baku",
        "meals": "No meals (flight arrival)"
      },
      {
        "day": 2,
        "morning": "Guided walking tour of Icherisheher (Old City), visiting the 12th-century Maiden Tower, Palace of the Shirvanshahs, and ancient stone caravanserais.",
        "afternoon": "Visit the world-renowned Heydar Aliyev Center for photo opportunities of its flowing curved architecture, followed by a walk along Baku Seaside Boulevard.",
        "evening": "Traditional Azerbaijani dinner at a historic Old City restaurant featuring saj, dolma, and live traditional mugam folk music.",
        "overnight": "Overnight at 4★ Central Hotel, Baku",
        "meals": "Breakfast included"
      },
      {
        "day": 3,
        "morning": "Depart on a full-day guided excursion to Gabala in the Caucasus Mountains, passing scenic pine valleys and Nohur Lake.",
        "afternoon": "Ride all 4 lines of the Tufandag Mountain Cable Car up to 1,920 meters for breathtaking Caucasian panoramas; visit 7 Beauties Waterfall.",
        "evening": "Return to Baku in the evening; free time for shopping at Park Bulvar or 28 Mall on the Caspian waterfront.",
        "overnight": "Overnight at 4★ Central Hotel, Baku",
        "meals": "Breakfast included"
      },
      {
        "day": 4,
        "morning": "Excursion to Gobustan National Park to explore 40,000-year-old prehistoric rock carvings and the active bubbling mud volcanoes.",
        "afternoon": "Visit Ateshgah Fire Temple and Yanar Dag (Burning Mountain natural gas flame) before private transfer to Baku International Airport.",
  ...
  "salalah-khareef-monsoon": {
    ...
    "dayBlocks": [
      {
        "day": 1,
        "morning": "Depart Dubai early morning aboard our luxury air-conditioned executive coach (or fly direct DXB–SLL on flydubai/SalamAir). Smooth border crossing into Oman.",
        "afternoon": "Scenic arrival into the misty green hills of Salalah. Check into your hotel and refresh.",
        "evening": "Visit Haffa Beach coconut and tropical banana fruit stalls; sip fresh tender coconut water and explore the traditional Frankincense souq.",
        "overnight": "Overnight in Salalah City Hotel",
        "meals": "Dinner included on bus package"
      },
      {
        "day": 2,
        "morning": "Guided excursion to eastern Dhofar: visit the breathtaking Wadi Darbat with emerald-green lagoons, boat rides, and cascading waterfalls.",
        "afternoon": "Drive up the mountain pass to Mirbat and Taqah Castle; witness the dramatic view from Taqah plateau overlooking the Arabian Sea.",
        "evening": "Relax at Ayn Razat natural spring gardens surrounded by lush lotus flowers and mountain hills.",
        "overnight": "Overnight in Salalah City Hotel",
        "meals": "Breakfast included"
      },
      {
        "day": 3,
        "morning": "Tour western Salalah: travel along the dramatic coastal highway to Mughsail Beach and witness the natural Marneef Cave and water blowholes.",
        "afternoon": "Ascend the zig-zag mountain road of Sarfait towards the Yemen border with panoramic views over the misty Indian Ocean cliffs.",
        "evening": "Traditional Omani barbecue dinner featuring local camel meat (Mudhbi) cooked on hot desert stones.",
        "overnight": "Overnight in Salalah City Hotel",
        "meals": "Breakfast included"
      },
      {
        "day": 4,
        "morning": "Visit Sultan Qaboos Grand Mosque in Salalah and Ayn Athum seasonal waterfall for final photography.",
        "afternoon": "Board return executive coach or transfer to Salalah Airport for flight back to Dubai.",
  ...
  "umrah-17-nights": {
    ...
    "dayBlocks": [
      {
        "day": 1,
        "morning": "Depart Dubai on direct flight to Jeddah King Abdulaziz International Airport (or executive luxury Umrah coach). Enter Ihram with guidance.",
        "afternoon": "VIP airport reception and private transfer to your hotel in Makkah Al Mukarramah. Check in and rest.",
        "evening": "Perform your first Umrah (Tawaf, Sa'i between Safa & Marwah, and Halq/Taqseer) escorted by our experienced Mutawwif guide.",
      ...
      },
      {
        ...
        "evening": "Maghrib and Isha prayers at the Kaaba, followed by free time for personal worship.",
        "overnight": "Overnight at Makkah Hotel near Haram",
        "meals": "Breakfast included"
      },
      {
        "day": 3,
        "morning": "Makkah Ziyarat Tour: visit Jabal Al Noor (Cave of Hira), Jabal Thawr, Mina, Muzdalifah, and Mount Arafat (Jabal Al Rahmah).",
      ...
      {
        "day": 11,
        "morning": "Perform Farewell Tawaf (Tawaf Al-Wada) in Makkah, hotel checkout, and transfer to Makkah Haramain Train Station.",
        "afternoon": "Ride the 300 km/h Haramain High-Speed Bullet Train through the desert to the illuminated city of Madinah Al Munawwarah (2 hours).",
        "evening": "Check into Madinah hotel, offer first Salam at Al Masjid An Nabawi, and pray in the blessed Prophet's Mosque.",
        "overnight": "Overnight at Madinah Hotel near Haram",
        "meals": "Breakfast included"
      },
      {
        "day": 18,
        "morning": "Final prayers and Salam at Al Masjid An Nabawi, hotel check-out, and private transfer to Prince Mohammad Bin Abdulaziz Airport in Madinah.",
  ...
  "bosnian-delight": {
    ...
    "dayBlocks": [
      {
        "day": 1,
        "morning": "Fly direct from Dubai (DXB) to Sarajevo International Airport (SJJ). Meet private English-speaking chauffeur at arrivals.",
        "afternoon": "Transfer to your 4★ central Sarajevo hotel, check in, and enjoy a traditional Bosnian coffee in the Baščaršija square.",
        "evening": "Take a scenic ride on the Sarajevo Cable Car up to Mount Trebević for sunset views over the entire city.",
        "overnight": "Overnight in Sarajevo",
        "meals": "No meals (arrival day)"
      },
      {
        "day": 2,
        "morning": "Guided tour of Sarajevo: Latin Bridge, Gazi Husrev-beg Mosque, Sahat Kula Clock Tower, and the Tunnel of Hope museum.",
        "afternoon": "Visit Vrelo Bosne, the lush natural springs of the River Bosna, with horse-drawn carriage rides along tree-lined avenues.",
        "evening": "Traditional Bosnian dinner featuring authentic Ćevapi and Burek pastries in the Old Town.",
        "overnight": "Overnight in Sarajevo",
        "meals": "Breakfast included"
      },
      {
        "day": 3,
        "morning": "Scenic drive through the Neretva river canyon to Konjic; visit the 6-arch Ottoman Stone Bridge and Tito's subterranean nuclear bunker.",
        "afternoon": "Continue to Jablanica for famous spit-roasted lamb by the river before driving to sunny Mostar.",
        "evening": "Check into Mostar hotel and stroll the cobblestone lanes of Kujundžiluk bazaar as the Old Bridge illuminates at night.",
        "overnight": "Overnight in Mostar",
        "meals": "Breakfast included"
      },
      {
        "day": 4,
        "morning": "Tour Mostar's UNESCO-listed Old Bridge (Stari Most), Koski Mehmed Pasha Mosque, and Turkish House (Kajtaz).",
        "afternoon": "Visit Blagaj Tekke, the 600-year-old Dervish monastery built into a 200m vertical cliff at the source of the emerald Buna River.",
      ...
      {
        "day": 6,
        "morning": "Breakfast, free time for souvenir copper shopping in Baščaršija, and private transfer to Sarajevo Airport.",
  ...
  "swiss-alpine-dream": {
    ...
    "dayBlocks": [
      {
        "day": 1,
        "morning": "Land in Zurich from Dubai, meet private chauffeur at arrivals for VIP transfer to central hotel.",
        "afternoon": "Check into 4★/5★ hotel, relax, and take a stroll along the Limmat river promenade.",
      ...
      {
        "day": 2,
        "morning": "Scenic train to Lucerne, walk the 14th-century wooden Chapel Bridge and Lion Monument.",
        "afternoon": "Explore cobblestone alleys and board a luxury catamaran cruise on Lake Lucerne.",
      ...
      {
        "day": 3,
        "morning": "Ascend Mount Titlis aboard the world's first revolving Rotair cable car through alpine clouds.",
        "afternoon": "Walk across the Titlis Cliff Walk and explore the Glacier Ice Cave.",
      ...
      {
        "day": 4,
        "morning": "Board the GoldenPass panoramic train toward Interlaken between Lakes Thun and Brienz.",
        "afternoon": "Stroll the Höheweg promenade with views of the Jungfrau massif.",
      ...
      {
        "day": 6,
        "morning": "Scenic train ride to Geneva along Lake Geneva with views of Lavaux terraced vineyards.",
        "afternoon": "Guided tour of Geneva: Jet d'Eau, Flower Clock, and United Nations headquarters.",
      ...
      {
        "day": 7,
        "morning": "Enjoy Swiss breakfast, hotel check-out assistance, and private transfer to Geneva Airport.",
  ...
  "maldives-overwater-escape": {
    ...
    "dayBlocks": [
      {
        "day": 1,
        "morning": "Arrive at Malé Velana Airport, met by resort host, board scenic seaplane/speedboat to resort island.",
        "afternoon": "Check into private Overwater Villa with glass floor panels and direct sea ladder.",
      ...
      },
      {
        ...
        "afternoon": "Private gourmet sandbank picnic lunch and swimming in untouched turquoise water.",
  ...
  "georgia-mountain-weekender": {
    ...
    "dayBlocks": [
      {
        "day": 1,
        "morning": "Direct 3.5h flight from Dubai to Tbilisi, meet private driver for transfer to Old Town hotel.",
        "afternoon": "Stroll along Rustaveli Avenue and ride the aerial cable car up to Narikala Fortress.",
        "evening": "Explore the Abanotubani sulfur bath district and enjoy traditional Khachapuri dinner.",
        "overnight": "Overnight in Tbilisi",
        "meals": "No meals"
      },
      {
        "day": 2,
        "morning": "Guided walking tour through Old Tbilisi's carved wooden balconies, Bridge of Peace, and Clock Tower.",
        "afternoon": "Excursion to Mtskheta (UNESCO ancient capital) and Jvari Monastery overlooking the river confluence.",
      ...
      {
        "day": 3,
        "morning": "Drive the Georgian Military Highway into the high Caucasus, stopping at Ananuri Fortress.",
        "afternoon": "Gudauri Friendship Monument viewpoint; switch into 4x4 Land Cruisers to climb to Gergeti Trinity Church (2,170m).",
      ...
      {
        "day": 4,
        "morning": "Leisure morning for mountain photography and souvenir shopping at Dry Bridge flea market.",
        "afternoon": "Private transfer to Tbilisi International Airport for evening flight back to Dubai.",
