...
// a beach umbrella and a lightning bolt is the single most recognisable
// "generated by a model" signal in a UI, and it is also imprecise — a
// lightning bolt does not mean "short trip" to anyone who has not been told.
// The words do the work; the pill's own shape and fill carry the state.
const TABS = [
  { id: "all", label: "All packages", filter: () => true },
  {
    id: "alpine",
  ...
  {
    id: "quick",
    label: "Short breaks, 4 days or less",
